...
We can answer multiple questions using regression analysis of the covid data. We will focus on new deaths and new positive cases, and we will use total deaths for some exceptions.
We can analyze the  statistical relation between these and various parameters like new vaccinations, age, population, etc using regression analysis of the covid dataset.
